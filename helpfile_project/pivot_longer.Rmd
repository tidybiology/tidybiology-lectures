...
### Description
pivot_longer() shifts column names into rows, making the data 'longer'. The original values under the columns are now sorted into a single column. This takes multiple columns with fewer rows and creates a combined column with many more rows. *This function is equivalent to, but replacing* **gather()** 

![Pivot longer schematic from http://www.storybench.org/pivoting-data-from-columns-to-rows-and-back-in-the-tidyverse/](pivotlong.png)

### **What is this function used for? (i.e. Google terms)**
"How do I tidy data in R?"  
"Make data longer R tidyverse"  
"Prepare data for plotting in R"  
"How do I plot multiple variables in ggplot?"  
...
## **Optional Input**
Below is a summary of the most useful optional inputs, but not all. More option can be found in the help page and resources listed at the end of this page.
